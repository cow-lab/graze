...
export function tabClass(active: boolean): string {
  return `px-3 py-1.5 rounded-md text-sm font-medium border shadow-sm transition duration-150 active:translate-y-px motion-reduce:active:translate-y-0 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-moss ${
    active
